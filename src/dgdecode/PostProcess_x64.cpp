...
static constexpr uint64_t mm64_0008 = 0x0008000800080008;
static uint64_t mm64_temp;
static constexpr uint64_t mm64_coefs[18] = {
...
inline void deblock_horiz_lpf9(uint8_t* v, int stride, int QP)
{
    for (int y = 0; y < 4; ++y) {
        ...
        __asm
        {
            ...
            movq    mm2, qword ptr[rax]       /* mm2 = v4v3v2v1xxxxxxxx    0 1 2w3 4 5 6 7    */
            ...
            pmullw    mm0, [rbx]               /* mm0 *= mm64_coefs[0]      0m1 2 3 4 5 6 7    */
            ...
            pmullw    mm0, 8[rbx]             /* mm2 *= mm64_coefs[1]      0m1 2 3 4 5 6 7    */
            movq      mm4, mm3                /* mm4 = __v2__v2__v2__v2    0 1 2 3r4w5 6 7    */

            pmullw    mm2, 16[rbx]            /* mm2 *= mm64_coefs[2]      0 1 2m3 4 5 6 7    */

            pmullw    mm3, 32[rbx]            /* mm3 *= mm64_coefs[4]      0 1 2 3m4 5 6 7    */

            pmullw    mm4, 24[rbx]            /* mm3 *= mm64_coefs[3]      0 1 2 3 4m5 6 7    */
            ...
            pmullw    mm1, 48[rbx]            /* mm1 *= mm64_coefs[6]      0 1m2 3 4 5 6 7    */

            pmullw    mm0, 40[rbx]            /* mm0 *= mm64_coefs[5]      0m1 2 3 4 5 6 7    */
            movq      mm4, mm2                /* mm4 = __v4__v4__v4__v4    0 1 2r3 4w5 6 7    */

            pmullw    mm2, 64[rbx]            /* mm2 *= mm64_coefs[8]      0 1 2 3 4 5 6 7    */
            paddw     mm6, mm1                /* mm6 += mm1                0 1 2 3 4 5 6 7    */

            pmullw    mm4, 56[rbx]            /* mm4 *= mm64_coefs[7]      0 1 2 3 4m5 6 7    */
            pxor      mm3, mm3                /* mm3 = 0000000000000000    0 1 2 3w4 5 6 7    */

            movq      mm1, 8[rax]             /* mm1 = xxxxxxxxv8v7v6v5    0 1w2 3 4 5 6 7    */
            ...
            pmullw    mm0, 72[rbx]            /* mm0 *= mm64_coefs[9]      0m1 2 3 4 5 6 7    */
            movq      mm4, mm3                /* mm4 = __v6__v6__v6__v6    0 1 2 3 4w5 6 7    */

            pmullw    mm2, 80[rbx]            /* mm2 *= mm64_coefs[10]     0 1 2m3 4 5 6 7    */

            pmullw    mm3, 96[rbx]            /* mm3 *= mm64_coefs[12]     0 1 2 3m4 5 6 7    */

            pmullw    mm4, 88[rbx]            /* mm4 *= mm64_coefs[11]     0 1 2 3 4m5 6 7    */
            paddw     mm5, mm0                /* mm5 += mm0                0r1 2 3 4 5 6 7    */
            ...
            pmullw    mm0, 104[rbx]           /* mm0 *= mm64_coefs[13]     0m1b2 3 4 5 6 7    */
            movq      mm4, mm2                /* mm4 = __v8__v8__v8__v8    0 1 2r3 4w5 6 7    */

            pmullw    mm1, 112[rbx]           /* mm1 *= mm64_coefs[14]     0 1w2 3 4 5 6 7    */
            punpckhbw mm3, mm7                /* mm0 = __p2__p2__p2__p2    0 1 2 3 4 5 6 7    */

            pmullw    mm2, 128[rbx]           /* mm2 *= mm64_coefs[16]     0 1b2m3 4 5 6 7    */

            pmullw    mm4, 120[rbx]           /* mm4 *= mm64_coefs[15]     0 1b2 3 4m5 6 7    */
            paddw     mm5, mm0                /* mm5 += mm0                0r1 2 3 4 5m6 7    */

            pmullw    mm3, 136[rbx]           /* mm0 *= mm64_coefs[17]     0 1 2 3m4 5 6 7    */
            ...
            movq      4[rax], mm6             /* v[] = mm6                 0 1 2 3 4 5 6r7    */
...
inline int deblock_horiz_useDC(uint8_t* v, int stride, int moderate_h)
{
    ...
    __asm
    {
        ...
        movq mm1, qword ptr[rax]    /* mm1 = *pmm            0 1 2 3 4 5 6 7    */
        ...
        movq mm3, qword ptr[rax]    /* mm3 = *pmm            0 1 2 3 4 5 6 7    */
        ...
        movq mm1, qword ptr[rax]    /* mm3 = *pmm            0 1 2 3 4 5 6 7    */
        ...
        movq mm5, qword ptr[rax]    /* mm5 = *pmm            0 1 2 3 4 5 6 7    */
...
inline void deblock_vert_choose_p1p2(uint8_t* v, int stride, uint64_t* p1p2, int QP)
{
    ...
    __asm
    {
        ...
        /* p1 */
        pxor     mm7, mm7             /* mm7 = 0                       */
        movq     mm0, [rax]           /* mm0 = *pmm1 = v[l0]           */
        movq     mm2, mm0             /* mm2 = mm0 = v[l0]             */
        add      eax, stride          /* pmm1 += stride                */
        movq     mm1, [rax]           /* mm1 = *pmm1 = v[l1]           */
        ...
        /* Store p1 in memory                                          */
        movq[rcx], mm0           /* low words to p1p2[0]          */
        movq     8[rcx], mm1          /* high words to p1p2[1]         */

        /* p2 */
        movq     mm1, [rbx]           /* mm1 = *pmm2 = v[l8]           */
        movq     mm3, mm1             /* mm3 = mm1 = v[l8]             */
        add      ebx, stride          /* pmm2 += stride                */
        movq     mm0, [rbx]           /* mm0 = *pmm2 = v[l9]           */
        ...
        /* Store p2 in memory                                               */
        movq     16[rcx], mm0         /* low words to p1p2[2]          */
        movq     24[rcx], mm1         /* high words to p1p2[3]         */
...
inline void deblock_vert_copy_and_unpack(int stride, uint8_t* source, uint64_t* dest, int n)
{
    ...
    __asm
    {
        ...
        movq   mm0, [rax]                     /* mm0 = v[0*stride]               */
            ...
            movq[rbx], mm0                     /* v_local[n] = mm0 (left)         */
            add   eax, stride                    /* p_data += stride                */

            movq   8[rbx], mm1                    /* v_local[n+8] = mm1 (right)      */
            punpckhbw mm3, mm7                     /* unpack high bytes (right hand 4)*/

            movq   16[rbx], mm2                   /* v_local[n+16] = mm2 (left)      */

            movq   24[rbx], mm3                   /* v_local[n+24] = mm3 (right)     */
...
inline void deblock_vert_default_filter(uint8_t* v, int stride, int QP)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        __asm
        {
            ...
            movd      mm1, [rcx]            /* mm1 = v5v5v5v5v5v5v5v5    0 1w2 3 4 5 6 7    */
            ...
            movd      mm4, [rcx]            /* mm4 = v6v6v6v6v6v6v6v6    0 1 2 3 4w5 6 7    */

            punpcklbw mm4, mm7               /* mm4 = __v6__v6__v6__v6 L  0 1 2 3 4m5 6 7r   */

            add      ecx, stride           /* ecx += stride              0 1 2 3 4 5 6 7    */

            movd      mm5, [rcx]            /* mm5 = v7v7v7v7v7v7v7v7    0 1 2 3 4 5w6 7    */
            ...
            movd      mm4, [rcx]            /* mm4 = v8v8v8v8v8v8v8v8    0 1 2 3 4w5 6 7    */
...
inline void deblock_vert_lpf9(uint64_t* v_local, uint64_t* p1p2, uint8_t* v, int stride)
{
    ...
    __asm
    {
        ...
        movq   mm2, [rax]                  /* mm2 = p1p2[0]               0 1 2w3 4 5 6 7    */
        add   ecx, stride                  /* ecx points at v[1*stride]   0 1 2 3 4 5 6 7    */

        movq   mm3, 8[rax]                 /* mm3 = p1p2[1]               0 1 2 3w4 5 6 7    */
        ...
        paddsw mm4, 16[rbx]                 /* mm4 += vv[1] left           0 1 2 3 4m5 6 7    */
        paddw  mm5, mm3                     /* mm5 += p2 left              0 1 2 3r4 5m6 7    */

        paddsw mm4, 32[rbx]                 /* mm4 += vv[2] left           0 1 2 3 4m5 6 7    */
        paddw  mm5, mm3                     /* mm5 += p2 left              0 1 2 3r4 5m6 7    */

        paddsw mm4, 48[rbx]                 /* mm4 += vv[3] left           0 1 2 3 4m5 6 7    */
        paddw  mm5, mm3                     /* mm5 += p2 left              0 1 2 3r4 5m6 7    */

        paddsw mm5, 24[rbx]                 /* mm5 += vv[1] right          0 1 2 3 4 5m6 7    */
        paddw  mm4, mm2                     /* mm4 += p1 left              0 1 2r3 4m5 6 7    */

        paddsw mm5, 40[rbx]                 /* mm5 += vv[2] right          0 1 2 3 4 5m6 7    */
        paddw  mm4, mm2                     /* mm4 += p1 left              0 1 2r3 4m5 6 7    */

        paddsw mm5, 56[rbx]                 /* mm5 += vv[3] right          0 1 2 3 4 5m6 7    */
        paddw  mm4, mm2                     /* mm4 += p1 left              0 1 2r3 4m5 6 7    */

        paddsw mm4, 64[rbx]                 /* mm4 += vv[4] left           0 1 2 3 4m5 6 7    */

        paddsw mm5, 72[rbx]                 /* mm5 += vv[4] right          0 1 2 3 4 5m6 7    */
        ...
        paddsw mm0, 16[rbx]                 /* mm0 += vv[1] left           0m1 2 3 4 5 6 7    */
        movq   mm1, mm5                     /* mm1 = psum right            0 1w2 3 4 5r6 7    */

        paddsw mm1, 24[rbx]                 /* mm1 += vv[1] right          0 1 2 3 4 5 6 7    */
        psllw  mm0, 1                       /* mm0 <<= 1                   0m1 2 3 4 5 6 7    */

        psubsw mm0, 64[rbx]                 /* mm0 -= vv[4] left           0m1 2 3 4 5 6 7    */
        psllw  mm1, 1                       /* mm1 <<= 1                   0 1 2 3 4 5 6 7    */

        psubsw mm1, 72[rbx]                 /* mm1 -= vv[4] right          0 1m2 3 4 5 6 7    */

        paddsw mm0, 80[rbx]                 /* mm0 += vv[5] left           0m1 2 3 4 5 6 7    */

        paddsw mm1, 88[rbx]                 /* mm1 += vv[5] right          0 1m2 3 4 5 6 7    */
        psrlw  mm0, 4                       /* mm0 >>= 4                   0m1 2 3 4 5 6 7    */

        /* psum += vv[5] - p1 */
        paddsw mm4, 80[rbx]                 /* mm4 += vv[5] left           0 1 2 3 4m5 6 7    */
        psrlw  mm1, 4                       /* mm1 >>= 4                   0 1m2 3 4 5 6 7    */

        paddsw mm5, 88[rbx]                 /* mm5 += vv[5] right          0 1 2 3 4 5 6 7    */
        psubsw mm4, [rax]                  /* mm4 -= p1 left              0 1 2 3 4 5 6 7    */

        packuswb mm0, mm1                   /* pack mm1, mm0 to mm0        0m1 2 3 4 5 6 7    */
        psubsw mm5, 8[rax]                 /* mm5 -= p1 right             0 1 2 3 4 5 6 7    */

        /* v[2] = (((psum + vv[2]) << 1) - (vv[5] - vv[6])) >> 4 */
        /* compute this in mm6 (left) and mm7 (right)   */
        movq   mm6, mm4                     /* mm6 = psum left             0 1 2 3 4 5 6 7    */

        paddsw mm6, 32[rbx]                 /* mm6 += vv[2] left           0 1 2 3 4 5 6 7    */
        movq   mm7, mm5                     /* mm7 = psum right            0 1 2 3 4 5 6 7    */

        paddsw mm7, 40[rbx]                 /* mm7 += vv[2] right          0 1 2 3 4 5 6 7    */
        psllw  mm6, 1                       /* mm6 <<= 1                   0 1 2 3 4 5 6 7    */

        psubsw mm6, 80[rbx]                 /* mm6 -= vv[5] left           0 1 2 3 4 5 6 7    */
        psllw  mm7, 1                       /* mm7 <<= 1                   0 1 2 3 4 5 6 7    */

        psubsw mm7, 88[rbx]                 /* mm7 -= vv[5] right          0 1 2 3 4 5 6 7    */

        movq[rcx], mm0                     /* v[1*stride] = mm0           0 1 2 3 4 5 6 7    */

        paddsw mm6, 96[rbx]                 /* mm6 += vv[6] left           0 1 2 3 4 5 6 7    */
        add   ecx, stride                    /* ecx points at v[2*stride]   0 1 2 3 4 5 6 7    */

        paddsw mm7, 104[rbx]                /* mm7 += vv[6] right          0 1 2 3 4 5 6 7    */

        /* psum += vv[6] - p1 */

        paddsw mm4, 96[rbx]                 /* mm4 += vv[6] left           0 1 2 3 4 5 6 7    */
        psrlw  mm6, 4                       /* mm6 >>= 4                   0 1 2 3 4 5 6 7    */

        paddsw mm5, 104[rbx]                /* mm5 += vv[6] right          0 1 2 3 4 5 6 7    */
        ...
        paddsw mm0, 48[rbx]                 /* mm0 += vv[3] left           0 1 2 3 4 5 6 7    */
        movq   mm1, mm5                     /* mm1 = psum right            0 1 2 3 4 5 6 7    */

        paddsw mm1, 56[rbx]                 /* mm1 += vv[3] right          0 1 2 3 4 5 6 7    */
        psllw  mm0, 1                       /* mm0 <<= 1                   0 1 2 3 4 5 6 7    */

        psubsw mm0, 96[rbx]                 /* mm0 -= vv[6] left           0 1 2 3 4 5 6 7    */
        psllw  mm1, 1                       /* mm1 <<= 1                   0 1 2 3 4 5 6 7    */

        psubsw mm1, 104[rbx]                /* mm1 -= vv[6] right          0 1 2 3 4 5 6 7    */

        movq[rcx], mm6                   /* v[2*stride] = mm6           0 1 2 3 4 5 6 7    */
        paddsw mm0, 112[rbx]                /* mm0 += vv[7] left           0 1 2 3 4 5 6 7    */

        paddsw mm1, 120[rbx]                /* mm1 += vv[7] right          0 1 2 3 4 5 6 7    */
        add   ecx, stride                   /* ecx points at v[3*stride]   0 1 2 3 4 5 6 7    */

        /* psum += vv[7] - p1 */
        paddsw mm4, 112[rbx]                /* mm4 += vv[5] left           0 1 2 3 4 5 6 7    */
        psrlw  mm0, 4                       /* mm0 >>= 4                   0 1 2 3 4 5 6 7    */

        paddsw mm5, 120[rbx]                /* mm5 += vv[5] right          0 1 2 3 4 5 6 7    */
        ...
        /* compute this in mm6 (left) and mm7 (right)    */
        movq[rcx], mm0                   /* v[3*stride] = mm0           0 1 2 3 4 5 6 7    */
        movq   mm6, mm4                     /* mm6 = psum left             0 1 2 3 4 5 6 7    */

        paddsw mm6, 64[rbx]                 /* mm6 += vv[4] left           0 1 2 3 4 5 6 7    */
        movq   mm7, mm5                     /* mm7 = psum right            0 1 2 3 4 5 6 7    */

        paddsw mm7, 72[rbx]                 /* mm7 += vv[4] right          0 1 2 3 4 5 6 7    */
        psllw  mm6, 1                       /* mm6 <<= 1                   0 1 2 3 4 5 6 7    */

        paddsw mm6, [rax]                   /* mm6 += p1 left              0 1 2 3 4 5 6 7    */
        psllw  mm7, 1                       /* mm7 <<= 1                   0 1 2 3 4 5 6 7    */

        paddsw mm7, 8[rax]                  /* mm7 += p1 right             0 1 2 3 4 5 6 7    */

        psubsw mm6, 16[rbx]                 /* mm6 -= vv[1] left           0 1 2 3 4 5 6 7    */

        psubsw mm7, 24[rbx]                 /* mm7 -= vv[1] right          0 1 2 3 4 5 6 7    */

        psubsw mm6, 112[rbx]                /* mm6 -= vv[7] left           0 1 2 3 4 5 6 7    */

        psubsw mm7, 120[rbx]                /* mm7 -= vv[7] right          0 1 2 3 4 5 6 7    */

        paddsw mm6, 128[rbx]                /* mm6 += vv[8] left           0 1 2 3 4 5 6 7    */
        add   ecx, stride                   /* ecx points at v[4*stride]   0 1 2 3 4 5 6 7    */

        paddsw mm7, 136[rbx]                /* mm7 += vv[8] right          0 1 2 3 4 5 6 7    */
        /* psum += vv[8] - vv[1] */

        paddsw mm4, 128[rbx]                /* mm4 += vv[5] left           0 1 2 3 4 5 6 7    */
        psrlw  mm6, 4                       /* mm6 >>= 4                   0 1 2 3 4 5 6 7    */

        paddsw mm5, 136[rbx]                /* mm5 += vv[5] right          0 1 2 3 4 5 6 7    */
        psrlw  mm7, 4                       /* mm7 >>= 4                   0 1 2 3 4 5 6 7    */

        psubsw mm4, 16[rbx]                 /* mm4 -= vv[1] left           0 1 2 3 4 5 6 7    */
        packuswb mm6, mm7                   /* pack mm7, mm6 to mm6        0 1 2 3 4 5 6 7    */

        psubsw mm5, 24[rbx]                 /* mm5 -= vv[1] right          0 1 2 3 4 5 6 7    */

        /* v[5] = (((psum + vv[5]) << 1) + (vv[1] - vv[2]) - vv[8] + p2) >> 4 */
        /* compute this in mm0 (left) and mm1 (right)    */
        movq   mm0, mm4                     /* mm0 = psum left             0 1 2 3 4 5 6 7    */

        paddsw mm0, 80[rbx]                 /* mm0 += vv[5] left           0 1 2 3 4 5 6 7    */
        movq   mm1, mm5                     /* mm1 = psum right            0 1 2 3 4 5 6 7    */

        paddsw mm1, 88[rbx]                 /* mm1 += vv[5] right          0 1 2 3 4 5 6 7    */
        psllw  mm0, 1                       /* mm0 <<= 1                   0 1 2 3 4 5 6 7    */

        paddsw mm0, 16[rax]                 /* mm0 += p2 left              0 1 2 3 4 5 6 7    */
        psllw  mm1, 1                       /* mm1 <<= 1                   0 1 2 3 4 5 6 7    */

        paddsw mm1, 24[rax]                 /* mm1 += p2 right             0 1 2 3 4 5 6 7    */

        paddsw mm0, 16[rbx]                 /* mm0 += vv[1] left           0 1 2 3 4 5 6 7    */
        movq[rcx], mm6                   /* v[4*stride] = mm6           0 1 2 3 4 5 6 7    */

        paddsw mm1, 24[rbx]                 /* mm1 += vv[1] right          0 1 2 3 4 5 6 7    */

        psubsw mm0, 32[rbx]                 /* mm0 -= vv[2] left           0 1 2 3 4 5 6 7    */

        psubsw mm1, 40[rbx]                 /* mm1 -= vv[2] right          0 1 2 3 4 5 6 7    */

        psubsw mm0, 128[rbx]                /* mm0 -= vv[8] left           0 1 2 3 4 5 6 7    */

        psubsw mm1, 136[rbx]                /* mm1 -= vv[8] right          0 1 2 3 4 5 6 7    */

        /* psum += p2 - vv[2] */
        paddsw mm4, 16[rax]                 /* mm4 += p2 left              0 1 2 3 4 5 6 7    */
        add   ecx, stride                   /* ecx points at v[5*stride]   0 1 2 3 4 5 6 7    */

        paddsw mm5, 24[rax]                 /* mm5 += p2 right             0 1 2 3 4 5 6 7    */

        psubsw mm4, 32[rbx]                 /* mm4 -= vv[2] left           0 1 2 3 4 5 6 7    */

        psubsw mm5, 40[rbx]                 /* mm5 -= vv[2] right          0 1 2 3 4 5 6 7    */
        ...
        psubsw mm6, 48[rbx]                 /* mm6 -= vv[3] left           0 1 2 3 4 5 6 7    */
        psrlw  mm1, 4                       /* mm1 >>= 4                   0 1 2 3 4 5 6 7    */

        psubsw mm7, 56[rbx]                 /* mm7 -= vv[3] right          0 1 2 3 4 5 6 7    */
        packuswb mm0, mm1                   /* pack mm1, mm0 to mm0        0 1 2 3 4 5 6 7    */

        movq[rcx], mm0                   /* v[5*stride] = mm0           0 1 2 3 4 5 6 7    */
        ...
        psubsw mm4, 48[rbx]                 /* mm4 -= vv[3] left           0 1 2 3 4 5 6 7    */
        add   ecx, stride                   /* ecx points at v[6*stride]   0 1 2 3 4 5 6 7    */

        psubsw mm5, 56[rbx]                 /* mm5 -= vv[3] right           0 1 2 3 4 5 6 7    */
        ...
        psubsw mm0, 64[rbx]                 /* mm0 -= vv[4] left           0 1 2 3 4 5 6 7    */

        psubsw mm1, 72[rbx]                 /* mm1 -= vv[4] right          0 1 2 3 4 5 6 7    */
        psrlw  mm0, 4                       /* mm0 >>= 4                   0 1 2 3 4 5 6 7    */

        movq[rcx], mm6                   /* v[6*stride] = mm6           0 1 2 3 4 5 6 7    */
        ...
        psubsw mm4, 64[rbx]                 /* mm4 -= vv[4] left            0 1 2 3 4 5 6 7    */
        psrlw  mm1, 4                       /* mm1 >>= 4                   0 1 2 3 4 5 6 7    */

        psubsw mm5, 72[rbx]                 /* mm5 -= vv[4] right 0 1 2 3 4 5 6 7    */
        ...
        movq[rcx], mm0                   /* v[7*stride] = mm0           0 1 2 3 4 5 6 7    */
        psrlw  mm7, 4                       /* mm7 >>= 4                   0 1 2 3 4 5 6 7    */
        ...
        movq[rcx], mm6                   /* v[8*stride] = mm6           0 1 2 3 4 5 6 7    */
...
void dering(uint8_t* image, int width, int height, int stride, QP_STORE_T* QP_store, int QP_stride, int chroma)
{
    ...
    for (y = 8; y < height - 8; y += 8)
    {
        for (x = 8; x < width - 8; x += 8)
        {
            ...
            __asm
            {
                mov     rsi, b8x8       // the block addr
                mov     eax, stride     // offset to next qword in block

                movq    mm0, qword ptr[rsi] // row 0, 1st qword is our min
                movq    mm1, mm0            // .. and our max

                pminub  mm0, qword ptr[rsi + rax]     // row 1
                pmaxub  mm1, qword ptr[rsi + rax]

                lea     rsi, [rsi + 2 * rax]            // bump for next 2
                pminub  mm0, qword ptr[rsi]         // row 2
                pmaxub  mm1, qword ptr[rsi]

                pminub  mm0, qword ptr[rsi + rax]     // row 3
                pmaxub  mm1, qword ptr[rsi + rax]

                lea     rsi, [rsi + 2 * rax]            // bump for next 2
                pminub  mm0, qword ptr[rsi]         // row 4
                pmaxub  mm1, qword ptr[rsi]

                pminub  mm0, qword ptr[rsi + rax]     // row 5
                pmaxub  mm1, qword ptr[rsi + rax]

                lea     rsi, [rsi + 2 * rax]            // bump for next 2
                pminub  mm0, qword ptr[rsi]         // row 6
                pmaxub  mm1, qword ptr[rsi]

                pminub  mm0, qword ptr[rsi + rax]     // row 7
                pmaxub  mm1, qword ptr[rsi + rax]
            ...
            */
            ...
            _asm
            {
                mov     rsi, b10x10                 // ptr to 10x10 source array
                lea     rdi, b8x8filtered           // ptr to 8x8 output array
                mov     eax, stride                 // amt to bump source ptr for next row

                movq    mm7, qword ptr[rsi]         // this is really line -1
                pavgb   mm7, qword ptr[rsi + 2]       // avg( b[v,h], b[v,h+2] }
                pavgb   mm7, qword ptr[rsi + 1]       // center weighted avg of 3 pixels  w=1,2,1

                lea     rsi, [rsi + rax]              // bump src ptr to point at line 0
                movq    mm0, qword ptr[rsi]         // really line 0
                pavgb   mm0, qword ptr[rsi + 2]
                movq    mm2, qword ptr[rsi + 1]       // save orig line 0 vals for later clip
                pavgb   mm0, mm2

                movq    mm1, qword ptr[rsi + rax]     // get line 1
                pavgb   mm1, qword ptr[rsi + rax + 2]
                movq    mm3, qword ptr[rsi + rax + 1]   // save orig line 1 vals for later clip
                pavgb   mm1, mm3
                ...
                movq    qword ptr[rdi], mm7

                lea     rsi, [rsi + 2 * rax]            // bump source ptr 2 lines
                movq    mm2, qword ptr[rsi]         // get line 2
                pavgb   mm2, qword ptr[rsi + 2]
                movq    mm4, qword ptr[rsi + 1]       // save orig line 2 vals for later clip
                pavgb   mm2, mm4
                ...
                movq    mm3, qword ptr[rsi + rax]     // get line 3
                pavgb   mm3, qword ptr[rsi + rax + 2]
                movq    mm5, qword ptr[rsi + rax + 1]   // save orig line 3 vals for later clip
                pavgb   mm3, mm5
                ...
                lea     rsi, [rsi + 2 * rax]            // bump source ptr 2 lines
                movq    mm4, qword ptr[rsi]         // get line 4
                pavgb   mm4, qword ptr[rsi + 2]
                movq    mm6, qword ptr[rsi + 1]       // save orig line 4 vals for later clip
                pavgb   mm4, mm6
                ...
                movq    qword ptr[rdi + 24], mm2

                movq    mm5, qword ptr[rsi + rax]     // get line 5
                pavgb   mm5, qword ptr[rsi + rax + 2]
                movq    mm7, qword ptr[rsi + rax + 1]   // save orig line 5 vals for later clip
                pavgb   mm5, mm7
                ...
                movq    qword ptr[rdi + 32], mm3

                lea     rsi, [rsi + 2 * rax]            // bump source ptr 2 lines
                movq    mm6, qword ptr[rsi]         // get line 6
                pavgb   mm6, qword ptr[rsi + 2]
                movq    mm0, qword ptr[rsi + 1]       // save orig line 6 vals for later clip
                pavgb   mm6, mm0
                ...
                movq    qword ptr[rdi + 40], mm4

                movq    mm7, qword ptr[rsi + rax]     // get line 7
                pavgb   mm7, qword ptr[rsi + rax + 2]
                movq    mm1, qword ptr[rsi + rax + 1]   // save orig line 7 vals for later clip
                pavgb   mm7, mm1
                ...
                movq    qword ptr[rdi + 48], mm5

                movq    mm0, qword ptr[rsi + 2 * rax]   // get line 8
                pavgb   mm0, qword ptr[rsi + 2 * rax + 2]
                pavgb   mm0, qword ptr[rsi + 2 * rax + 1]
            ...
            _asm
            {
                ...
                movq    mm3, qword ptr[rsi + 1]       // save center pixels of line -1

                movq    mm2, mm7
                psubusb mm2, qword ptr[rsi]         // left pixels >= threshold?
                ...
                movq    mm5, mm7
                psubusb mm5, qword ptr[rsi + 2]       // right pixels >= threshold?
                pcmpeqb mm5, mm6
                pavgb   mm2, mm5                    // combine answers

                lea     rsi, [rsi + rax]              // &row 0

                // get compare avg of row 0
                movq    mm4, qword ptr[rsi + 1]       // save center pixels

                movq    mm0, mm7
                psubusb mm0, qword ptr[rsi]         // left pixels >= threshold?
                ...
                movq    mm3, qword ptr[rsi + rax + 1]   // save center pixels

                movq    mm1, mm7
                psubusb mm1, qword ptr[rsi + rax]     // left pixels >= threshold?
                ...
                movq    mm5, mm7
                psubusb mm5, qword ptr[rsi + rax + 2]   // right pixels >= threshold?
                pcmpeqb mm5, mm6
                pavgb   mm1, mm5                    // combine answers
                ...
                pand    mm5, qword ptr[rdi]         // use filterd vales if thresh's same, else 00
                por     mm5, mm2                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 1

                // get compare avg of row 2

                movq    mm4, qword ptr[rsi + rax + 1]   // save center pixels

                movq    mm2, mm7
                psubusb mm2, qword ptr[rsi + rax]     // left pixels >= threshold?
                pcmpeqb mm2, mm6                    // ff if >= else 00
                ...
                pand    mm5, qword ptr[rdi + 1 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm0                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 2
                ...
                movq    mm0, mm7
                psubusb mm0, qword ptr[rsi + rax]     // left pixels >= threshold?
                pcmpeqb mm0, mm6                    // ff if >= else 00
                ...
                pand    mm5, qword ptr[rdi + 2 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm1                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 3
                ...
                pand    mm5, qword ptr[rdi + 3 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm2                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 4
                ...
                pand    mm5, qword ptr[rdi + 4 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm0                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 5
                ...
                pand    mm5, qword ptr[rdi + 5 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm1                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 6
                ...
                pcmpeqb mm2, mm5                    // opposite of mm5
                pand    mm2, mm4                    // use orig vales if thresh's diff, else 00
                pand    mm5, qword ptr[rdi + 6 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm2                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels

                lea     rsi, [rsi + rax]              // &row 7
                ...
                pcmpeqb mm0, mm5                    // opposite of mm5
                pand    mm0, mm3                    // use orig vales if thresh's diff, else 00
                pand    mm5, qword ptr[rdi + 7 * 8]     // use filterd vales if thresh's same, else 00
                por     mm5, mm0                    // one of them hsa a value
                movq    qword ptr[rsi + 1], mm5       // and store 8 pixels
